...
STARTING_BRAKE_RATE = 5.5  # brake_travel/s while releasing on restart
BRAKE_STOPPING_TARGET = 1.5 # apply at least this amount of brake to maintain the vehicle stationary
