...
_A_CRUISE_MIN_V = [-1.5, -1.5, -1.5, -1.5, -0.5]
_A_CRUISE_MIN_V_FOLLOWING = [-8.0, -8.0, -8.0, -8.0, -8.0]
_A_CRUISE_MIN_BP = [ 0.0, 5.0,  10.0, 20.0,  55.0]

# need fast accel at very low speed for stop and go
# make sure these accelerations are smaller than mpc limits
_A_CRUISE_MAX_V = [1.5, 1.5, 0.65, 0.4,]
_A_CRUISE_MAX_V_FOLLOWING = [1.5, 2.0, 0.65, 0.4]
